...
export class Employee extends Component {
    ...
    FilterFn() {
        var Department_IDFilter = this.state.Department_IDFilter;
        ...
        var filteredData = this.state.departmentsWithoutFilter.filter(
            function (el) {
                return el.Department_ID.toString().toLowerCase().includes(
                    Department_IDFilter.toString().trim().toLowerCase()
                ) &&
    ...
    changeDepartment_IDFilter = (e) => {
        this.state.Department_IDFilter = e.target.value;
        this.FilterFn();
    }
                            ...
                            <th>
                                <div className="d-flex flex-row">
                                    ...
                                    <input className="form-control m-2"
                                        onChange={this.changeDepartment_IDFilter}
                                        placeholder="Filter" />

                                    <button type="button" className="btn btn-light"
                                        onClick={() => this.sortResult('Department_ID', true)}>
                                    ...
                                    <button type="button" className="btn btn-light"
                                        onClick={() => this.sortResult('Department_ID', false)}>
